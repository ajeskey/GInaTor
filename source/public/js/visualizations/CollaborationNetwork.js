...
(function () {
  ...
  CollaborationNetwork.prototype.resize = function () {
    this._render();
  };
  ...
  CollaborationNetwork.prototype._render = function () {
    ...
    this._fetch(this._apiUrl('/api/v1/collaboration'))
      .then(function (data) {
        self.data = data;
        self._draw(data);
      })
  ...
  CollaborationNetwork.prototype._draw = function (data) {
    ...
    var linkSel = svg
      ...
      .attr('stroke-width', function (d) {
        return Math.max(1, (d.weight / maxWeight) * 6);
      });
