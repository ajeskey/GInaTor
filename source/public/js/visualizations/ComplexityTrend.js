...
(function () {
  ...
  ComplexityTrend.prototype.resize = function () {
    this._render();
  };
  ...
  ComplexityTrend.prototype._render = function () {
    ...
    this._fetch(this._apiUrl('/api/v1/complexity', extra))
      .then(function (data) {
        self.data = data;
        self._draw(data);
      })
    ...
    g.selectAll('.ct-dot')
      ...
      .on('click', function (event, d) {
        window.dispatchEvent(
          new CustomEvent('viz:open-diff', { detail: { file: d.file, date: d.date.toISOString() } })
        );
      });
