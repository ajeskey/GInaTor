...
(function () {
  ...
  ImpactViz.prototype.resize = function () {
    this._render();
  };
  ...
  ImpactViz.prototype._render = function () {
    ...
    this._fetch(this._apiUrl('/api/v1/impact'))
      .then(function (data) {
        self.data = data;
  ...
  ImpactViz.prototype._drawEmpty = function () {
    ...
    svg
      .append('text')
      .attr('x', this._dims().width / 2)
      .attr('y', this._dims().height / 2)
  ...
  ImpactViz.prototype._drawCommit = function (commit) {
    ...
    files.forEach(function (file, i) {
      ...
      g.append('line')
        ...
        .attr('y2', ey)
        .attr('stroke', color)
        .attr('stroke-width', Math.max(1, Math.log2(fileChanges + 1)))
        .attr('opacity', 0.7);
