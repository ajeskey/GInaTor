...
const { computeFileTypeDistribution } = require('./computations');

function createFiletypesRouter(commitStore) {
  ...
  router.get('/', async (req, res) => {
    try {
      ...
      return res.json(computeFileTypeDistribution(commits));
    } catch (err) {
      console.error('Error computing filetypes:', err);
...
module.exports = { createFiletypesRouter };
