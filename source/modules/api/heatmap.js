...
const { computeHeatmap } = require('./computations');

function createHeatmapRouter(commitStore) {
  ...
  router.get('/', async (req, res) => {
    try {
      ...
      return res.json(computeHeatmap(commits));
    } catch (err) {
...
module.exports = { createHeatmapRouter };
