...
export const metadata: Metadata = {
  title:
    "Next.js AI Text Generator | GInaTor - Next.js Admin Dashboard Template",
  description:
    "This is AI Next.js Text Generator page for GInaTor - Next.js Tailwind CSS Admin Dashboard Template",
};
